...
public class StringUtils {
	...
	public static String escapeString(String src) {
		if (httl.util.StringUtils.isEmpty(src)) {
			return src;
		}
		int len = src.length();
	...
	public static String unescapeString(String value) {
		if (httl.util.StringUtils.isEmpty(value)) {
			return value;
		}
		StringBuilder buf = null;
		int len = value.length();
	...
	public static String getConditionCode(Class<?> type, String code, String[] sizers) throws ParseException {
		if (type != boolean.class) {
			if (type == byte.class 
				...
				if (httl.util.StringUtils.isNotEmpty(method)) {
	...
	public static String removeCommaValue(String values, String value) {
		return httl.util.StringUtils.joinByComma(CollectionUtils.remove(httl.util.StringUtils.splitByComma(values), value));
	}
	...
	public static String splitCamelName(String name, String split, boolean upper) {
		if (httl.util.StringUtils.isEmpty(name)) {
			return name;
		}
